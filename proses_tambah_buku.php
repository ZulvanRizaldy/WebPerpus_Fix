...
if($_POST){
    ...
    // $nama_buku = mysqli_real_escape_string($conn, $_POST['judul_buku']);
    ...
    if(empty($judul_buku)){
        echo "<script> alert ('Judul buku tidak boleh kosong'); 
        ...
        $foto = 'http://localhost/Perpustakaan1/foto_produk/'.$namaFile;
        // $foto = $namaFile;
        $link = "insert into buku (judul_buku, penulis, penerbit, deskripsi, foto) values ('".$judul_buku."','".$penulis."','".$penerbit."','".$deskripsi."','".$foto."')";
